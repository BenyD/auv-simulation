        ...
        <Suspense fallback={<LoadingSpinner />}>
          <MotionWrapper className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800/95 dark:to-gray-950 transition-colors duration-300">
              ...
              <div className="max-w-[2000px] mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-2 text-xs">
                    <span className="px-2 py-1 bg-blue-100 dark:bg-blue-950 rounded text-blue-700 dark:text-blue-300 transition-colors duration-300">
                      TensorFlow.js
                    </span>
                    <span className="px-2 py-1 bg-black dark:bg-white rounded text-white dark:text-black transition-colors duration-300">
                      Next.js
                    </span>
                  </div>
                </div>
            ...
            <motion.footer
              ...
              animate={{ y: 0 }}
              transition={{ type: "spring", stiffness: 100, damping: 20 }}
              className="fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-t border-gray-200/80 dark:border-gray-800/80 transition-all duration-300"
            >
